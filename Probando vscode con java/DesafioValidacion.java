...
public class DesafioValidacion {
    ...
    public static void esValida(String password){
        ...
        if (password.length() >= 8) {
            ...
            for (int i=0; i < password.length(); i++){
                ...
                if (especial = password.contains(".") || password.contains("-") || password.contains("_") || password.contains("#") || password.contains("$") || password.contains("!") || password.contains("?")){
                    especial = true;
                }
